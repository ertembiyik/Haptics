...
public extension UIColor {
    ...
    var hex: String {
        ...
        // disable XDR
        red = red.clamped(lowerBound: 0, upperBound: 1)
        green = green.clamped(lowerBound: 0, upperBound: 1)
        blue = blue.clamped(lowerBound: 0, upperBound: 1)
        alpha = alpha.clamped(lowerBound: 0, upperBound: 1)
